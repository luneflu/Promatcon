...
export const ui = {
  en: {
    ...
    "products.tab.gas": "Gas Compressor",
    "products.tab.vessel": "Pressure Vessel",
    "products.tab.workshop": "Workshop Facility",
    "products.workshop.title": "Facility & Logistics",
    "products.workshop.area": "Total Area",
    "products.workshop.area.desc": "200 m × 350 m site layout",
    "products.workshop.roof": "Under Roof Workshop",
    "products.workshop.roof.desc": "Enclosed fabrication area",
    "products.workshop.output": "Monthly Output",
    "products.workshop.output.desc": "Forecast at Balaraja plant",
    "products.workshop.logistics": "Logistics Access",
    "products.workshop.airport": "Airport",
    "products.workshop.seaport": "Sea Port",
    "products.workshop.capacity": "Fabrication Capacity",
    "products.workshop.height": "Maximum Height",
    "products.workshop.height.desc": "Vertical fabrication capability for large column structures.",
    "products.workshop.thickness": "Max Wall Thickness",
    "products.workshop.thickness.desc": "Fabrication thickness experience for heavy-wall pressure vessels.",
    "products.workshop.fleet": "Lifting Fleet Capacity",
    "products.workshop.fleet.sub": "(4 units overhead)",
    "products.workshop.fleet.desc": "For heavy lifting up to 100 Ton, mobile or crawler cranes are utilized on site.",
    "products.workshop.machinery": "Machinery & Equipment List",
    "products.workshop.machinery.cat": "Category",
    "products.workshop.machinery.model": "Machine / Model",
    "products.workshop.machinery.spec": "Technical Specifications",
    "products.workshop.roll.bend": "Bending Roll Machine",
    "products.workshop.roll.bend.thick": "Thickness:",
    "products.workshop.roll.bend.width": "Rolling Width:",
    "products.workshop.roll.turn": "Turning Roll Machine",
    "products.workshop.roll.turn.desc": "Heavy-duty rotational positioning for cylindrical vessel welding.",
    "products.workshop.cut": "Cutting Machine",
    "products.workshop.weld": "Welding Machines",
    "products.workshop.weld.unit": "units",
  ...
  id: {
    ...
    "products.tab.gas": "Kompresor Gas",
    "products.tab.vessel": "Bejana Tekan",
    "products.tab.workshop": "Fasilitas Workshop",
    "products.workshop.title": "Fasilitas & Logistik",
    "products.workshop.area": "Total Area",
    "products.workshop.area.desc": "Tata letak situs 200 m × 350 m",
    "products.workshop.roof": "Workshop Beratap",
    "products.workshop.roof.desc": "Area fabrikasi tertutup",
    "products.workshop.output": "Output Bulanan",
    "products.workshop.output.desc": "Prakiraan di pabrik Balaraja",
    "products.workshop.logistics": "Akses Logistik",
    "products.workshop.airport": "Bandara",
    "products.workshop.seaport": "Pelabuhan Laut",
    "products.workshop.capacity": "Kapasitas Fabrikasi",
    "products.workshop.height": "Tinggi Maksimum",
    "products.workshop.height.desc": "Kemampuan fabrikasi vertikal untuk struktur kolom besar.",
    "products.workshop.thickness": "Ketebalan Dinding Maks",
    "products.workshop.thickness.desc": "Pengalaman ketebalan fabrikasi untuk bejana tekan berdinding tebal.",
    "products.workshop.fleet": "Kapasitas Armada Angkat",
    "products.workshop.fleet.sub": "(4 unit overhead)",
    "products.workshop.fleet.desc": "Untuk pengangkatan berat hingga 100 Ton, derek mobil atau perayap digunakan di lokasi.",
    "products.workshop.machinery": "Daftar Mesin & Peralatan",
    "products.workshop.machinery.cat": "Kategori",
    "products.workshop.machinery.model": "Mesin / Model",
    "products.workshop.machinery.spec": "Spesifikasi Teknis",
    "products.workshop.roll.bend": "Mesin Bending Roll",
    "products.workshop.roll.bend.thick": "Ketebalan:",
    "products.workshop.roll.bend.width": "Lebar Gulungan:",
    "products.workshop.roll.turn": "Mesin Turning Roll",
    "products.workshop.roll.turn.desc": "Pemosisian rotasi tugas berat untuk pengelasan bejana silinder.",
    "products.workshop.cut": "Mesin Pemotong",
    "products.workshop.weld": "Mesin Las",
    "products.workshop.weld.unit": "unit",
